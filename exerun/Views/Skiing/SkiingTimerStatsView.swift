...
class SkiingTimerStatsView: UIView {
    ...
    func displayStats(_ skiingSessionModel: SkiingSessionModel) {
        timerLabel.text = "\(skiingSessionModel.time)\n\(skiingSessionModel.distance)"
        firstStatsStackView.updateStats(at: 0, withNumberText: skiingSessionModel.maxSpeed)
        firstStatsStackView.updateStats(at: 1, withNumberText: skiingSessionModel.speed)
        firstStatsStackView.updateStats(at: 2, withNumberText: skiingSessionModel.avgPace)
        secondStatsStackView.updateStats(at: 0, withNumberText: skiingSessionModel.averageHeartRate)
        secondStatsStackView.updateStats(at: 1, withNumberText: skiingSessionModel.heartRate)
        secondStatsStackView.updateStats(at: 2, withNumberText: skiingSessionModel.avgSpeed)
        thirdStatsStackView.updateStats(at: 0, withNumberText: skiingSessionModel.minElevation)
        thirdStatsStackView.updateStats(at: 1, withNumberText: skiingSessionModel.totalElevationGain)
        thirdStatsStackView.updateStats(at: 2, withNumberText: skiingSessionModel.maxElevation)
    }
