...
class HikeMapStatsView: UIView {
    ...
    func displayStats(_ hikeSessionModel: HikeSessionModel) {
        statsStackView.updateStats(at: 0, withNumberText: hikeSessionModel.time)
        statsStackView.updateStats(at: 1, withNumberText: hikeSessionModel.speed)
        statsStackView.updateStats(at: 2, withNumberText: hikeSessionModel.distance)
    }
