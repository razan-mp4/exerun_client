...
class RunTimerStatsView: UIView {
    ...
    func displayStats(_ runSessionModel: RunSessionModel) {
        timerLabel.text = "\(runSessionModel.time)\n\(runSessionModel.distance)"
        firstStatsStackView.updateStats(at: 0, withNumberText: runSessionModel.maxSpeed)
        firstStatsStackView.updateStats(at: 1, withNumberText: runSessionModel.totalElevationGain)
        firstStatsStackView.updateStats(at: 2, withNumberText: runSessionModel.avgPace)
        secondStatsStackView.updateStats(at: 0, withNumberText: runSessionModel.speed)
        secondStatsStackView.updateStats(at: 1, withNumberText: runSessionModel.heartRate)
        secondStatsStackView.updateStats(at: 2, withNumberText: runSessionModel.avgSpeed)
    }
