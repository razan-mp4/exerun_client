...
class RunFinishedViewController: UIViewController, AddPictureViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    @objc func dontSaveTapped() {
        performSegue(withIdentifier: "FreeRunFinishedToHistorySegue", sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "FreeRunFinishedToHistorySegue",
...
//        let newWorkout = FreeRunWorkOutEntity(context: context)
//        newWorkout.name = nameTextField.text?.isEmpty == false ? nameTextField.text : "Run Workout"
