...
class RunningViewController: UIViewController {
    ...
    private var runningConditionLabel: UILabel!
    ...
    private func setupUI() {
        ...
        weatherImageView.image = UIImage(named: "no_data_running") // Placeholder image
        ...
        // Free Run Button
        freeRunButton = createStyledButton(withTitle: "Free Run", action: #selector(freeRunButtonTapped))
        
        // Build Run Button
        buildRunButton = createStyledButton(withTitle: "Build Run", action: #selector(buildRunButtonTapped))
        
        // Sets Run Button
        setsRunButton = createStyledButton(withTitle: "Sets Run", action: #selector(setsRunButtonTapped))
        ...
        // Add Buttons to View
        view.addSubview(freeRunButton)
        view.addSubview(buildRunButton)
        view.addSubview(setsRunButton)
        ...
        runningConditionLabel = createStyledLabel()
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            // Free Run Button
            freeRunButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            freeRunButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            freeRunButton.bottomAnchor.constraint(equalTo: buildRunButton.topAnchor, constant: -10),
            
            // Build Run Button
            buildRunButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            buildRunButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            buildRunButton.bottomAnchor.constraint(equalTo: setsRunButton.topAnchor, constant: -10),
            
            // Sets Run Button
            setsRunButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            setsRunButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            setsRunButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -20),
    ...
    private func updateUI(with weatherData: WeatherDataModel) {
            ...
            if let sunriseTime = dateFormatter.date(from: sunRise),
               let sunsetTime = dateFormatter.date(from: sunSet) {
                if currentTime >= sunriseTime && currentTime <= sunsetTime {
                    ...
                    sunEventLabel.text = "Remember, Sunsets at \(sunsetString)"
                } else {
                    // Nighttime
                    let timeFormatter = DateFormatter()
                    timeFormatter.dateFormat = "h:mm a"
                    let sunriseString = timeFormatter.string(from: sunriseTime)
                    sunEventLabel.text = "Remember, Sunrises at \(sunriseString)"
                }
            } else {
        ...
        if let weatherCode = weatherData.weatherCode {
            ...
            weatherImageView.image = UIImage(named: "no_data_running")
        }
        
        runningConditionLabel.text = determineRunningCondition(
        ...
        if let weatherCode = weatherData.weatherCode {
            // Adjust intensity dynamically if you have a metric like precipitation intensity
    ...
    private func determineWeatherImage(for weatherCode: Int, isDayTime: Bool) -> String {
        switch weatherCode {
        case 0: return isDayTime ? "day_clear_running" : "night_clear_running" // Clear
        case 1001: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Cloudy
        case 1100: return isDayTime ? "day_clear_running" : "night_clear_running" // Mostly Clear
        case 1101: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Partly Cloudy
        case 1102: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Mostly Cloudy
        case 2000: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Fog
        case 2100: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Light Fog
        case 3000: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Light Wind
        case 3001: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Wind
        case 3002: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Strong Wind
        case 4000: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Drizzle
        case 4200: return isDayTime ? "day_rain_running" : "night_rain_running" // Light Rain
        case 4001: return isDayTime ? "day_rain_running" : "night_rain_running" // Rain
        case 4201: return isDayTime ? "day_rain_running" : "night_rain_running" // Heavy Rain
        case 5000: return isDayTime ? "day_snow_running" : "night_snow_running" // Snow
        case 5001: return isDayTime ? "day_snow_running" : "night_snow_running" // Flurries
        case 5100: return isDayTime ? "day_snow_running" : "night_snow_running" // Light Snow
        case 5101: return isDayTime ? "day_snow_running" : "night_snow_running" // Heavy Snow
        case 6000: return isDayTime ? "day_cloudy_running" : "night_cloudy_running" // Freezing Drizzle
        case 6001: return isDayTime ? "day_rain_running" : "night_rain_running" // Freezing Rain
        case 6200: return isDayTime ? "day_rain_running" : "night_rain_running" // Light Freezing Rain
        case 6201: return isDayTime ? "day_rain_running" : "night_rain_running" // Heavy Freezing Rain
        case 7000: return isDayTime ? "day_rain_running" : "night_rain_running" // Ice Pellets
        case 7101: return isDayTime ? "day_rain_running" : "night_rain_running" // Heavy Ice Pellets
        case 7102: return isDayTime ? "day_rain_running" : "night_rain_running" // Light Ice Pellets
        case 8000: return isDayTime ? "day_rain_running" : "night_rain_running" // Thunderstorm
        default: return "no_data_running" // Default image
        }
    }
    
    private func determineRunningCondition(temp: Double, visibility: Double, precipitation: Double, weatherCode: Int) -> String {
        switch weatherCode {
        case 4000, 4200, 4001, 4201: // Drizzle, Light Rain, Rain, Heavy Rain
            return "Rainy conditions, be cautious!"
