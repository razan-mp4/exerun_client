//
//  HikeWalkFinishedViewController.swift
//  exerun
//
...
class HikeWalkFinishedViewController: UIViewController, AddPictureViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate {
    
    var hikeSessionModel: HikeSessionModel!
    ...
    private func setupBackgroundImage() {
        ...
        let backgroundImageView = UIImageView(image: UIImage(named: "no_data_hiking"))
    ...
    private func setupNameTextField() {
        ...
        nameTextField.placeholder = "Enter hike name"
    ...
    private func setupStatsLabel() {
        ...
        let statsData = [
            ...
            ("Time", hikeSessionModel.time),
            ("Average Pace", hikeSessionModel.avgPace),
            ("Average Speed", hikeSessionModel.avgSpeed),
            ("Distance", hikeSessionModel.distance),
            ("Max Speed", hikeSessionModel.maxSpeed),
            ("Elevation Gain", hikeSessionModel.totalElevationGain),
            ("Max Heart Rate", hikeSessionModel.maxHeartRate),
            ("Average Heart Rate", hikeSessionModel.averageHeartRate),
            ("Min Elevation", hikeSessionModel.minElevation),
            ("Max Elevation", hikeSessionModel.maxElevation)
        ]
    ...
    @objc func dontSaveTapped() {
        performSegue(withIdentifier: "HikeFinishedToHistorySegue", sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "HikeFinishedToHistorySegue",
