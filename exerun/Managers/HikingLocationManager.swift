...
protocol HikingLocationManagerDelegate: AnyObject {
...
class HikingLocationManager: NSObject, CLLocationManagerDelegate {
    ...
    weak var delegate: HikingLocationManagerDelegate?
