...
// MARK: – Skiing -----------------------------------------------------------
extension SkiingSessionModel: WorkoutSessionConvertible {
    typealias Entity = SkiingWorkOutEntity
    func fill(_ e: SkiingWorkOutEntity) {
        e.avgPace          = avgPace
