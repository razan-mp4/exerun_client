//
//  CyclingWorkOutEntity+CoreDataProperties.swift
//  
//
...
extension CyclingWorkOutEntity {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<CyclingWorkOutEntity> {
        return NSFetchRequest<CyclingWorkOutEntity>(entityName: "CyclingWorkOutEntity")
    }
...
extension CyclingWorkOutEntity : HasSegments, HasImageData {}
